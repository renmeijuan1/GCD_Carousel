...
@interface BannerWebImageManager()
...
@implementation BannerWebImageManager

+ (instancetype)shareManager {
    
    static BannerWebImageManager *instance;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[BannerWebImageManager alloc] init];
    });
